...
class ColorToBlackAndWhite {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final BufferedImage colorImage = ImageIO.read(f);
        ...
        final BufferedImage blackAndWhiteImage1 = new BufferedImage(
                colorImage.getWidth(),
                colorImage.getHeight(),
                BufferedImage.TYPE_3BYTE_BGR);
        g = blackAndWhiteImage1.createGraphics();
        g.drawImage(colorImage, 0, 0, null);
        ...
        g.drawImage(blackAndWhiteImage1, 0, 0, null);
